...
export class ProvinceNoSQLParams {
    ...
    public insertCountryTbl(obj:any)
    {
        ...
        Item: {
            ...
            'codeVal' : obj.data.provinceCd,
            'valueVal' : obj.data.provinceNm,
            'description' : obj.data.description,
            'detail1' : obj.data.countryCd,
            'detail2' : obj.data.countryNm,
            'statusVal' : 'active',
    ...
    public updateProvinceTbl(obj:any)
    {
        var day=dateFormat(new Date(), "yyyy-mm-dd h:MM:ss");
        let finalParams: any = {
        TableName: this.manageConfigTbl,
